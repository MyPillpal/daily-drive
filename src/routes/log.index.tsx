          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-1">
                ...
                <span className={`text-[11px] font-bold px-2 py-0.5 rounded-full ${ScoreBadgeColor(post.founderScore)}`}>
                  {post.founderScore}
                </span>
              </div>
            ...
            <div className="flex items-center gap-4 shrink-0">
              <div className="text-right">
                <span className="text-lg font-bold font-display text-foreground">{post.hours}</span>
